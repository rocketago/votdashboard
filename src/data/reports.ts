...
export const REPORTS: Record<string, StateReport> = {
  ...
  CA: { reg: 30, pledge: 1, students: 0, events: 0 },
  CO: { reg: 0, pledge: 0, students: 0, events: 0 },
  FL: { reg: 1, pledge: 0, students: 0, events: 0 },
  GA: { reg: 7, pledge: 0, students: 0, events: 0 },
  ...
  NC: { reg: 3, pledge: 0, students: 0, events: 0 },
  NE: { reg: 0, pledge: 0, students: 0, events: 0 },
  NH: { reg: 0, pledge: 0, students: 0, events: 0 },
  NJ: { reg: 142, pledge: 0, students: 0, events: 0 },
  NM: { reg: 0, pledge: 0, students: 0, events: 0 },
  NV: { reg: 0, pledge: 0, students: 0, events: 0 },
  NY: { reg: 12, pledge: 1, students: 0, events: 0 },
  OH: { reg: 0, pledge: 0, students: 0, events: 0 },
  PA: { reg: 47, pledge: 1, students: 0, events: 0 },
  SC: { reg: 225, pledge: 1, students: 0, events: 0 },
  TX: { reg: 5, pledge: 1, students: 0, events: 0 },
  VA: { reg: 201, pledge: 0, students: 0, events: 0 },
