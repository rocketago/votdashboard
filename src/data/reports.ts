...
export const REPORTS: Record<string, StateReport> = {
  ...
  CA: { reg: 10, pledge: 1, students: 0, events: 0 },
  ...
  NJ: { reg: 12, pledge: 0, students: 0, events: 0 },
  ...
  PA: { reg: 9, pledge: 1, students: 0, events: 0 },
  SC: { reg: 11, pledge: 1, students: 0, events: 0 },
  TX: { reg: 5, pledge: 1, students: 0, events: 0 },
  VA: { reg: 66, pledge: 0, students: 0, events: 0 },
